...
<div class="container mx-auto p-4">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold">Daftar Penugasan TNI</h2>
        <a href="index.php?entity=penugasan&action=add" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Tambah Penugasan
        </a>
    </div>
        ...
        <table class="min-w-full bg-white">
            <thead class="bg-gray-800 text-white">
                <tr>
                    ...
                    <th class="py-3 px-4 text-left">Nama Personil</th>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-100">
                    ...
                    <td class="py-3 px-4"><?php echo $penugasan['nama_personil']; ?></td>
                    <td class="py-3 px-4"><?php echo $penugasan['nama_pangkat']; ?></td>
                    <td class="py-3 px-4"><?php echo $penugasan['nrp']; ?></td>
                    ...
                    <td class="py-3 px-4">
                        ...
                        <a href="index.php?entity=penugasan&action=delete&id=<?php echo $penugasan['id']; ?>" class="text-red-500 hover:text-red-700" onclick="return confirm('Apakah Anda yakin ingin menghapus penugasan ini?')">Hapus</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
